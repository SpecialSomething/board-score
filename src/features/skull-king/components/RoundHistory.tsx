...
export default function RoundHistory({
  ...
  return (
    <section className="rounded-2xl border border-board-border bg-board-surface p-5 text-board-text shadow-[0_2px_8px_rgba(0,0,0,0.08)]">
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="min-w-full border-separate border-spacing-0 text-sm">
          <thead>
            <tr>
              <th className="whitespace-nowrap border-b border-board-border p-2 text-left">
                라운드
              </th>
              {players.map((player) => (
                <th
